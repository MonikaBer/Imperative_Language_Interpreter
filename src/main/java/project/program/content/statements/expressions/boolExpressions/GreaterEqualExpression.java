...
public class GreaterEqualExpression extends BoolExpression {

    private final NumericalExpression leftOperand;
    private final NumericalExpression rightOperand;

    public GreaterEqualExpression(NumericalExpression leftOperand, NumericalExpression rightOperand) {
